<template>
    <div class="submit-page">
        ...
        <form>
            ...
            <v-select label="分类" name="type" :items="items" itemText="label" itemValue="value"></v-select>
...
.submit-page {
    ...
    .icon-box{
        background: url(//appsco.pe/img/appscope-logo-background.png) no-repeat center center #f5f5f5;
